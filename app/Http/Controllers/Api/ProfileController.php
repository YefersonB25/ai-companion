...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'health.allergies.*'              => 'string|max:100',
            'health.conditions'               => 'nullable|array',
            'health.conditions.*'             => 'string|max:150',
            ...
            'preferences.hobbies'             => 'nullable|array',
            'preferences.hobbies.*'           => 'string|max:100',
            ...
            'goals.short_term'                => 'nullable|array',
            'goals.short_term.*'              => 'string|max:200',
            'goals.long_term'                 => 'nullable|array',
            'goals.long_term.*'               => 'string|max:200',
